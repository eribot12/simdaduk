  ...
  <form action="" method="post" enctype="multipart/form-data">
    <div class="card-body">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-6">
          <input type="text" class="form-control" id="no_akta_cerai" name="no_akta_cerai" placeholder="Akta Cerai " required>
        </div>
      </div>

      <div class="form-group row">
        <label class="col-sm-2 col-form-label">NIK Mantan Suami</label>
        <div class="col-sm-6">
          <input type="text" class="form-control" id="nik_mantan_suami" name="nik_mantan_suami" placeholder="NIK Mantan Suami" required>
        </div>
      </div>
      ...
      <div class="form-group row">
        <label class="col-sm-2 col-form-label">NIK Mantan Istri</label>
        <div class="col-sm-6">
          <input type="text" class="form-control" id="nik_mantan_istri" name="nik_mantan_istri" placeholder="NIK Mantan Istri" required>
        </div>
      </div>
      ...
      <div class="form-group row">
        <label class="col-sm-2 col-form-label">Tanggal Cerai</label>
        <div class="col-sm-3">
          <input type="date" class="form-control" id="tgl_cerai" name="tgl_cerai" placeholder="Tanggal Cerai" required>
        </div>
      </div>
  ...
  if ($query_simpan) {
    echo "<script>
      Swal.fire({title: 'Tambah Data Berhasil',text: '',icon: 'success',confirmButtonText: 'OK'
          ...
          window.location = 'index.php?page=akta-perceraian';
          }
      })</script>";
  } else {
    echo "<script>
