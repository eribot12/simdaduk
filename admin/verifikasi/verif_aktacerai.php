<h3 class="text-center font-weight-bold">VERIFIKASI AKTA CERAI</h3>
...
if (isset($_POST['Simpan'])) {
  ...
  $sql_simpan = "INSERT INTO verif_dokumen (id_kendali,	doc1,	doc2,	doc3,	doc4) VALUES('$id','$doc1','$doc2','$doc3','$doc4')";
  $query_simpan = mysqli_query($koneksi, $sql_simpan);
  ...
  if ($query_simpan) {
    echo "<script>
      Swal.fire({title: 'Tambah Data Berhasil',text: '',icon: 'success',confirmButtonText: 'OK'
          ...
          window.location = 'index.php?page=verif-aktacerai';
          }
      })</script>";
  } else {
    echo "<script>
