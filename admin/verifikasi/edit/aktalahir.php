<form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-check-inline">
                <label class="form-check-label">
                    <?php if ($data_dok['doc14'] == 'Y'): ?>
                        <input type="checkbox" class="form-check-input" name="doc14" value="Y" checked>Surat Kelahiran dari Kelurahan
                    <?php else: ?>
    ...
    <div class="card-footer">
        <input type="submit" name="UbahLahir" value="Simpan" class="btn btn-info">
