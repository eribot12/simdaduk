<form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-check-inline">
                <label class="form-check-label">
                    <?php if ($data_dok['doc3'] == 'Y'): ?>
                        <input type="checkbox" class="form-check-input" name="doc3" value="Y" checked>Surat Keterangan Kelahiran dari Kelurahan
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                    <input type="date" class="form-control" id="tgl_verif_operator2" name="tgl_verif_operator2"
                        value="<?= $data_cek['tgl_verif_operator2']; ?>" placeholder="Tanggal">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="time" class="form-control" id="jam_verif_operator2" name="jam_verif_operator2"
                        value="<?= $data_cek['jam_verif_operator2']; ?>" class="form-control">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                    <input type="date" class="form-control" id="tgl_verif_petugas2" name="tgl_verif_petugas2"
                        value="<?= $data_cek['tgl_verif_petugas2']; ?>" placeholder="Tanggal">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Jam</label>
                <div class="col-sm-6">
                    <input type="time" class="form-control" id="jam_verif_petugas2" name="jam_verif_petugas2"
                        value="<?= $data_cek['jam_verif_petugas2']; ?>" class="form-control">
                </div>
            </div>
            <div class="form-check">
    ...
    <div class="card-footer">
        <input type="submit" name="UbahKK" value="Simpan" class="btn btn-info">
