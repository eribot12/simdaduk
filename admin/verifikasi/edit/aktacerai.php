<form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-check-inline">
                <label class="form-check-label">
                    <?php if ($data_dok['doc1'] == 'Y'): ?>
                        <input type="checkbox" class="form-check-input" name="doc1" value="Y" checked>Putusan Pengadilan (Legalisir)
                    <?php else: ?>
    ...
    <div class="card-footer">
        <input type="submit" name="UbahCerai" value="Simpan" class="btn btn-info">
