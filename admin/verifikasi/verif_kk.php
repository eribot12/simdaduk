<h3 class="text-center font-weight-bold">VERIFIKASI KARTU KELUARGA</h3>
...
<form action="" method="post" enctype="multipart/form-data">
  ...
  <div class="card card-secondary">
    ...
    <div class="card-body">
      ...
      <div class="form-check-inline">
        <label class="form-check-label">
          <input type="checkbox" class="form-check-input" name="doc3" value="Y">Surat Keterangan Kelahiran dari Kelurahan
        </label>
      </div>
      <div class="form-check-inline">
        <label class="form-check-label">
  ...
  <div class="card card-secondary">
    ...
    <div class="card-body">
      ...
      <div class="form-group row">
        <label class="col-sm-2 col-form-label">Tanggal</label>
        <div class="col-sm-3">
          <input type="date" class="form-control" id="tgl_verif_operator2" name="tgl_verif_operator2" placeholder="Tanggal">
        </div>
      </div>
      ...
      <div class="form-group row">
        <label class="col-sm-2 col-form-label">Jam</label>
        <div class="col-sm-6">
          <input type="time" class="form-control" id="jam_verif_operator2" name="jam_verif_operator2" class="form-control">
        </div>
      </div>
  ...
  <div class="card card-secondary">
    ...
    <div class="card-body">
      ...
      <div class="form-group row">
        <label class="col-sm-2 col-form-label">Tanggal</label>
        <div class="col-sm-3">
          <input type="date" class="form-control" id="tgl_verif_petugas2" name="tgl_verif_petugas2" placeholder="Tanggal">
        </div>
      </div>
      <div class="form-group row">
        <label class="col-sm-2 col-form-label">Jam</label>
        <div class="col-sm-6">
          <input type="time" class="form-control" id="jam_verif_petugas2" name="jam_verif_petugas2" class="form-control">
        </div>
      </div>
      <div class="form-check">
...
if (isset($_POST['Simpan'])) {
  ...
  $sql_simpan = "INSERT INTO verif_dokumen (id_kendali,	doc1,	doc2,	doc3,	doc4,	doc5,	doc6,	doc7,	doc8,	doc9,	doc10,	doc11,	doc12) VALUES('$id','$doc1','$doc2','$doc3','$doc4','$doc5','$doc6','$doc7','$doc8','$doc9','$doc10','$doc11','$doc12')";
  $query_simpan = mysqli_query($koneksi, $sql_simpan);
  ...
  if ($query_simpan) {
    echo "<script>
      Swal.fire({title: 'Tambah Data Berhasil',text: '',icon: 'success',confirmButtonText: 'OK'
          ...
          window.location = 'index.php?page=verif-kk';
          }
      })</script>";
  } else {
    echo "<script>
