<h3 class="text-center font-weight-bold">VERIFIKASI KIA</h3>
  ...
  <div class="card card-secondary">
    ...
    <div class="card-body">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-6">
          <input type="time" class="form-control" id="jam_verif_pelayanan" name="jam_verif_pelayanan" class="form-control">
        </div>
      </div>
...
if (isset($_POST['Simpan'])) {
  ...
  $sql_simpan = "INSERT INTO verif_dokumen (id_kendali,	doc1,	doc2,	doc3,	doc4,	doc5) VALUES('$id','$doc1','$doc2','$doc3','$doc4','$doc5')";
  $query_simpan = mysqli_query($koneksi, $sql_simpan);
  ...
  if ($query_simpan) {
    echo "<script>
      Swal.fire({title: 'Tambah Data Berhasil',text: '',icon: 'success',confirmButtonText: 'OK'
          ...
          window.location = 'index.php?page=verif-kia';
          }
      })</script>";
  } else {
    echo "<script>
