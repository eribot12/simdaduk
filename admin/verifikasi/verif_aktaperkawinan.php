<h3 class="text-center font-weight-bold">VERIFIKASI AKTA PERKAWINAN</h3>
...
<form action="" method="post" enctype="multipart/form-data">
  ...
  <div class="card card-secondary">
    ...
    <div class="card-body">
      ...
      <div class="form-check-inline">
        <label class="form-check-label">
          <input type="checkbox" class="form-check-input" name="doc2" value="">F.2-02
        </label>
      </div>
      <div class="form-check-inline">
        <label class="form-check-label">
...
if (isset($_POST['Simpan'])) {
  ...
  $sql_simpan = "INSERT INTO verif_dokumen (id_kendali,	doc1,	doc2,	doc3,	doc4,	doc5,	doc6,	doc7,	doc8,	doc9,	doc10,	doc11,	doc12,	doc13,	doc14) VALUES('$id','$doc1','$doc2','$doc3','$doc4','$doc5','$doc6','$doc7','$doc8','$doc9','$doc10','$doc11','$doc12','$doc13','$doc14')";
  $query_simpan = mysqli_query($koneksi, $sql_simpan);
  ...
  if ($query_simpan) {
    echo "<script>
      Swal.fire({title: 'Tambah Data Berhasil',text: '',icon: 'success',confirmButtonText: 'OK'
          ...
          window.location = 'index.php?page=verif-aktaperkawinan';
          }
      })</script>";
  } else {
    echo "<script>
