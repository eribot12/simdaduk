	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
                ...
                if ($data_cek['level'] == "Kasi") echo "<option value='Kasi' selected>Kasi</option>";
                else echo "<option value='Kasi'>Kasi</option>";
                ...
                if ($data_cek['level'] == "Kabid") echo "<option value='Kabid' selected>Kabid</option>";
                else echo "<option value='Kabid'>Kabid</option>";
            ?>
					</select>
				</div>
			</div>
